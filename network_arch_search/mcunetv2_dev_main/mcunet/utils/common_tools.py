...
def val2list(val, repeat_time=1):
    """
    Converts the input value into a list. If the input is already a list or a NumPy array, it is returned as is.
    If the input is a tuple, it is converted to a list. For other input types, the value is repeated
    `repeat_time` times to create a list.
